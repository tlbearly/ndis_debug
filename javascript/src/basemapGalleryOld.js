...
function createMyBasemapGallery(){
  ...
  "dojo/dom-construct",
  "dijit/TitlePane"], (Expand,Basemap,VectorTileLayer,MapImageLayer,FeatureLayer,domConstruct,TitlePane)  => {
            var layer;
            var basemap;
           ...
           /* var layerQuads = new MapImageLayer({url:"https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_FSTopoQuad_01/MapServer"});
            ...
            class MyBasemapGallery {  
              constructor(){
                  ...
                  document.getElementById("basemapDiv").appendChild(basemapPane.domNode);
                  basemapPane.domNode.querySelector('.dijitTitlePaneContentInner').appendChild(this.bmGallery);*/
                  var node = domConstruct.create("div");
                  var header = domConstruct.create("h3", {
                    innerHTML: "Basemaps"
                  });
                  header.style.margin="0";
                  node.className="esri-component, esri-widget, esri-widget--panel";
                  node.style.backgroundColor="#fff";
                  node.style.padding="5px";
                  node.appendChild(header);
                  node.appendChild(this.bmGallery);
                  const bgExpand = new Expand({
                    ...
                    content: node, //document.getElementById("basemapDiv"),
