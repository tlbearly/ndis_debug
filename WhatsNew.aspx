...
<h4><a href="<%=Request.Querystring("app")%>/help.html">Help</a> &#149;
	<a href="<%=Request.Querystring("app")%>/definitions.html">Map
Information</a></h4>

<h2>Version 3.1 Released July 2016</h2>
<ul>
<li><strong>New <%=Request.Querystring("subtitle")%></strong><br/>Here are some of the new features:
	<ul>
...
<ul>
<li><strong>New <%=Request.Querystring("subtitle")%></strong> rewritten so that it is faster and will work on Macs.<br/>Here are some of the new features:
