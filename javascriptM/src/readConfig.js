		...
		xhttp.onreadystatechange = function () {
			if (xhttp.readyState == 4 && xhttp.status == 200) {
                ...
                // &layer= streets|layer2|.8|3-5-12,layer3|.65|2-6-10-12
					...
					try {
						var logo = xmlDoc.getElementsByTagName("logo")[0].firstChild.nodeValue;
					} catch (e) {
						alert("Error in " + app + "/config.xml file. Missing tag: logo.", "Data Error");
					}
					try {
						var logourl = xmlDoc.getElementsByTagName("logourl")[0].firstChild.nodeValue;
					} catch (e) {
